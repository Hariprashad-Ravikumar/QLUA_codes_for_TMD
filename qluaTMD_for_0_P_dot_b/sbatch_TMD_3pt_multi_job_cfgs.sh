...
srun -n 192 --export=CFG=$cfg_no --job-name=${job_name} /global/homes/s/smeinel/Perlmutter/QLUA/installation-202212-rc3-gcc/qlua/bin/qlua cfg.qlua ThreePT_TMD_cfg_b030_etaX.qlua
